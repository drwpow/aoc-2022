...
// I’m not writing a parser for this dumb format that’s boring
// also I’d rather play around with more structured interop than straight string passing
const input = {
  stacks: [
    ["N", "D", "M", "Q", "B", "P", "Z"],
    ["C", "L", "Z", "Q", "M", "D", "H", "V"],
  ...
  instructions: `move 3 from 2 to 5
move 2 from 9 to 6
move 4 from 7 to 1
move 7 from 3 to 4
move 2 from 9 to 8
