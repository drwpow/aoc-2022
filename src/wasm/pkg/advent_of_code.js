...
* @returns {any}
*/
export function day01(input) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.day01(ptr0, len0);
...
export function day02(input) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.day02(ptr0, len0);
    return takeObject(ret);
}
...
export function day03(input) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.day03(ptr0, len0);
    return takeObject(ret);
}
...
* @returns {any}
*/
export function day05(input_raw) {
    const ret = wasm.day05(addHeapObject(input_raw));
    return takeObject(ret);
}
...
* @returns {any}
*/
export function day09(input) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.day09(ptr0, len0);
    return takeObject(ret);
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('advent_of_code_bg.wasm', import.meta.url);
    }
    const imports = getImports();
